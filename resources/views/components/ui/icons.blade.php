{{-- 
    Sistema de Ícones SVG Sprite
    
    Este arquivo define todos os ícones como <symbol> dentro de um SVG oculto.
    Os ícones são carregados uma vez e reutilizados via <use href="#icon-name">
    
    Vantagens:
    - Zero requests HTTP extras
    - Cache do navegador (inline no HTML)
    - Estilização via CSS (fill, stroke, color)
    - Menor bundle que Font Awesome (~300KB) ou Google Icons
    - Sem FOIT/FOUT (Flash of Invisible/Unstyled Text)
--}}
...
<svg xmlns="http://www.w3.org/2000/svg" class="hidden">
    <defs>
        ...
        <symbol id="icon-success" viewBox="0 0 24 24" fill="currentColor">
        ...
        <symbol id="icon-loading" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
        </symbol>
        
        <symbol id="icon-dots-vertical" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 5a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm0 6.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm0 6.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"/>
        </symbol>
        
        <symbol id="icon-dots-horizontal" viewBox="0 0 24 24" fill="currentColor">
            <path d="M5 12a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm6.5 0a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm6.5 0a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"/>
        </symbol>
        
        <symbol id="icon-megaphone" viewBox="0 0 24 24" fill="currentColor">
        ...
        <symbol id="icon-document" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <symbol id="icon-qrcode" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
